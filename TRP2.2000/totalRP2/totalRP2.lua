...
function TRP2REAddFicha ()
   ...
   LB1:SetWidth(380)
   LB1:SetText  ("--- PUNTOS DE ATRIBUTO ---\n|cff00ffffFisico: |c00ffffff" .. tostring(TRP2RE["RE_Fisico"]) 
                .. " |cff00ffffDestreza:|c00ffffff " .. tostring(TRP2RE["RE_Destreza"])
                .. " |cff00ffffInteligencia:|c00ffffff " .. tostring(TRP2RE["RE_Inteligencia"])
                .. " |cff00ffffPercepción:|c00ffffff " .. tostring(TRP2RE["RE_Percepcion"])
                .. "\n\n--- VALORES DE COMBATE ---\n|cff00ff00Mana:|c00ffffff " .. tostring(TRP2RE["RE_Mana"])
                .. " |cff00ff00Vida:|c00ffffff " .. tostring(TRP2RE["RE_Vida"])
                .. " |cff00ff00Iniciativa:|c00ffffff " .. tostring(TRP2RE["RE_Iniciativa"])
                .. " |cff00ff00Defensa:|c00ffffff " .. tostring(TRP2RE["RE_Defensa"])
				.. "\n\n--- HABILIDADES ---" .. HabStr
				)
   ABText:AddChild (LB1)
end
function TRP2REQueryFicha ( AllFlds )
   ...
   local LB1 = AceGUI:Create("Label")
   LB1:SetWidth(380)
   LB1:SetText  ("--- PUNTOS DE ATRIBUTO ---\n|cff00ffffFisico:|c00ffffff " .. tostring(RE_Fisico) 
                .. " |cff00ffffDestreza:|c00ffffff " .. tostring(RE_Destreza)
                .. " |cff00ffffInteligencia:|c00ffffff " .. tostring(RE_Inteligencia)
                .. " |cff00ffffPercepción:|c00ffffff " .. tostring(RE_Percepcion)
                .. "\n\n--- VALORES DE COMBATE ---\n|cff00ff00 Mana:|c00ffffff " .. tostring(RE_Mana)
                .. "|cff00ff00 Vida:|c00ffffff " .. tostring(RE_Vida)
                .. "|cff00ff00 Iniciativa:|c00ffffff " .. tostring(RE_Iniciativa)
                .. "|cff00ff00 Defensa:|c00ffffff " .. tostring(RE_Defensa)
				.. "\n\n--- HABILIDADES ---" .. HabStr
				)
   ABText:AddChild (LB1)                                
end
